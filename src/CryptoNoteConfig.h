...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(11946724033309558371));
...
const char     CRYPTONOTE_NAME[]                             = "nigacoin";
...
const int      P2P_DEFAULT_PORT                              = 2482;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 3695;
